...
llmSummary: A cognitive-behavioral therapy (CBT) technique for improving mood and motivation. It involves intentionally scheduling positive, rewarding, or mastery-oriented activities to counteract feelings of depression, apathy, or low energy.
status: published
tags:
  - well-being
seo:
  ...
  description: >-
    Use intentional scheduling to combat low mood by reconnecting with joy and
    meaning in your life. Learn how to fill your week with rewarding
    experiences.
---
...
To read more about defining your core values and see a list of example ones, you can check the [Personal Values Clarification](./personal-values-clarification.mdx) tool.
