...
llmSummary: A problem-solving method that involves breaking down a complex problem into its most basic, fundamental truths and then reassembling a solution from the ground up.
status: published
tags:
  - mental-model
seo:
