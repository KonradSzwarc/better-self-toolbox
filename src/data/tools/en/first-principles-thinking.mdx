...
seo:
  ...
  description: 'See how First Principles Thinking can help you innovate and make better decisions. Learn to deconstruct problems to core truths and rebuild smarter solutions.'
---

## What is First Principles Thinking?

First Principles Thinking (also called_first principles reasoning) is essentially about getting back to basics. It means breaking down a problem or idea into its most fundamental parts (the things you know are absolutely true) and then using those to solve the problem in a new way. It's like taking apart a complex LEGO model into individual bricks, then using those bricks to build something entirely different.
...
To truly grasp the power of first principles, we first need to understand the default way our brains operate. Most of the time, we're not thinking from first principles; we're doing the opposite.
...
A fantastic tool for this is the [Five Whys](../5-whys) technique where you simply state your problem and ask "Why?" five times (or as many times as it takes).
...
[Socratic Questioning](../socratic-questioning) is a great tool for this. It's a disciplined process of asking probing questions to challenge your own thinking and uncover hidden beliefs. It forces you to provide evidence for your ideas rather than just accepting them.
