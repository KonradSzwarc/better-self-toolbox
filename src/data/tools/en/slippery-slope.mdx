...
llmSummary: A logical fallacy which argues that a specific initial action will inevitably lead to a chain of related events culminating in some significant, usually negative, effect.
status: published
tags:
  - fallacy
seo:
