...
llmSummary: A core technique of cognitive-behavioral therapy (CBT) that involves identifying, challenging, and replacing negative or irrational thought patterns (cognitive distortions) with more balanced ones.
status: published
tags:
  - well-being
seo:
  ...
  description: >-
    Step-by-step guide on using Thought Records. Shift unhelpful thoughts into
    balanced perspectives, reduce anxiety, and build confidence with realistic
    thinking.
---
