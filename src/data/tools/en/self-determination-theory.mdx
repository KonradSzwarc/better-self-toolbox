...
llmSummary: "A macro theory of human motivation and personality that concerns people's inherent growth tendencies. It posits three innate psychological needs: competence, autonomy, and relatedness."
status: published
tags:
  - well-being
seo:
...
- **Do a values check-in.**<br/>
  Regularly pause to ask: Are my major decisions and routines aligned with what I care about most? You can use tools like a [personal values list](./personal-values-clarification.mdx) to reconnect with what matters to you and make conscious adjustments if you've drifted.
