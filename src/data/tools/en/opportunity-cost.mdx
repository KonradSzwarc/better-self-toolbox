...
seo:
  ...
  description: 'The opportunity cost is the value of what you give up when you choose one option over another. Learn how to spot it and make better decisions.'
---
...
Don't use opportunity cost as an excuse for inaction. Sometimes the cost of not deciding is higher than making an imperfect choice. Many people forget that not making a decision is also a choice ([omission bias](../omission-bias)) and it comes with its own opportunity cost. Over time, the hidden costs of inaction can add up, sometimes outweighing the risks of simply making a choice and moving forward.
