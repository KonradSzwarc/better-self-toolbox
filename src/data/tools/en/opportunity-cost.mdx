...
llmSummary: An economic and decision-making principle referring to the value of the next-best alternative that was not chosen. Considering this helps in making more informed decisions.
status: published
tags:
  - mental-model
seo:
