...
llmSummary: 'A root cause analysis technique used for problem-solving. It involves repeatedly asking "Why?" (typically five times) to trace an issue back to its fundamental origin rather than addressing only immediate symptoms.'
status: published
tags:
  - mental-model
seo:
