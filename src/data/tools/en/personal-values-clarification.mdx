...
llmSummary: An introspective exercise designed to identify and prioritize your core personal values. This understanding serves as a foundation for authentic decision-making and goal-setting.
status: published
tags:
  - life-design
seo:
  ...
  description: >-
    Authenticity starts with knowing what you stand for. Learn to identify your
    personal core values and use them as a compass for life decisions and
    challenges.
---
...
Now, compile a broad list of value words or phrases that resonate with you. You can use the reflections from step 1 and consult the [Common Values List](#common-core-values-list-for-inspiration) provided in this note for inspiration. Read through the list of values and mark any that give you a strong "yes, that matters to me!" feeling.
