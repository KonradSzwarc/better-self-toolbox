...
To counter it, actively seek out stories of failure. Search for "Why I quit being a [target profession]" or "The hardest part about [target goal]." This provides a more balanced set of assumptions to map. You read more in a note about the [Survivorship Bias](../survivorship-bias).
