...
llmSummary: A strategic planning tool for identifying and testing critical assumptions. It involves mapping assumptions on a grid based on their importance and the level of evidence available.
status: published
tags:
  - mental-model
seo:
  ...
  description: >-
    Gain clarity using the Assumptions Map mental model. Identify, test, and
    validate the underlying beliefs that shape your life choices and influence
    decisions.
---
...
To counter it, actively seek out stories of failure. Search for "Why I quit being a [target profession]" or "The hardest part about [target goal]." This provides a more balanced set of assumptions to map. You read more in a note about the [Survivorship Bias](./survivorship-bias.mdx).
