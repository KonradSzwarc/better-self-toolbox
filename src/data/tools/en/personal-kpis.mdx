...
seo:
  ...
  description: 'Learn how to create and use Personal KPIs to measure what truly matters in your health, relationships, career, and more. Turn life goals into a clear dashboard.'
---
...
- **Example:** Increase long run distance by 1 km each week (if training for a marathon). Add 5 lbs to my squat weight each month (if training for a powerlifting competition).
...
- **Example:** Daily planning (e.g. spend 10 minutes each morning planning my day). Time management (e.g. [Pomodoro focus sessions](../pomodoro-technique) completed daily). Distraction breaks (e.g. limit YouTube to 2 videos per day).
