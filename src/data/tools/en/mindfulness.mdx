...
Some days your mind will be very busy, and sitting quietly might feel challenging - that doesn't mean you failed. The benefit comes from showing up to practice and exercising that mindfulness muscle, even if it doesn't seem like anything is happening.

Over time, you'll likely notice that you're quicker to notice when you're distracted or upset, and more able to return to a balanced state. If traditional sitting meditation isn't your thing, that's okay too - mindfulness can be practiced in many different forms, which we'll explore next.
