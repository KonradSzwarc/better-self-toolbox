...
llmSummary: A critical thinking and decision-making process that involves thinking beyond the immediate, first-level consequences of an action to consider the longer-term, indirect effects.
status: published
tags:
  - mental-model
seo:
  ...
  description: >-
    Learn the mental model of second-order thinking to make better decisions.
    Uncover long-term and indirect consequences to make choices that truly serve
    you.
---
