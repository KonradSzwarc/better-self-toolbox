...
llmSummary: A risk management strategy where a team or individual imagines that a project has failed and then works backward to determine what potential causes led to that failure.
status: published
tags:
  - mental-model
seo:
  ...
  description: >-
    Learn about the pre-mortem decision-making mental model. Imagine your
    project has already failed, then work backwards to identify the reasons for
    the failure.
---
